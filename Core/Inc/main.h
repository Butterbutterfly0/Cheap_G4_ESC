...
/* Private defines -----------------------------------------------------------*/
#define WORK_LIGHT_Pin GPIO_PIN_13
#define WORK_LIGHT_GPIO_Port GPIOC
#define Busbar_MEAS_Pin GPIO_PIN_0
#define Busbar_MEAS_GPIO_Port GPIOA
...
#define SPI_CS_MAG_Pin GPIO_PIN_4
#define SPI_CS_MAG_GPIO_Port GPIOC
#define W_MEAS_Pin GPIO_PIN_0
#define W_MEAS_GPIO_Port GPIOB
#define BUZZER_Pin GPIO_PIN_1
#define BUZZER_GPIO_Port GPIOB
#define FLASH_WP_Pin GPIO_PIN_2
#define FLASH_WP_GPIO_Port GPIOB
#define SPI_CS_FLASH_Pin GPIO_PIN_10
#define SPI_CS_FLASH_GPIO_Port GPIOB
#define V_MEAS_Pin GPIO_PIN_11
...
#define INPUT_PWM_Pin GPIO_PIN_5
#define INPUT_PWM_GPIO_Port GPIOB
